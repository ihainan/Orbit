                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-shrink-0">
                      {avatarUrl ? (
                        ...
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center text-blue-600 ring-2 ring-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {post.media && post.media.length > 0 && (
                        <div className="flex gap-1 mb-2">
                          ...
                          {post.media.length > 4 && (
                            <div className="w-16 h-16 bg-gray-300 flex items-center justify-center text-xs text-gray-600 font-semibold rounded">
                              +{post.media.length - 4}
                            </div>
                          )}
                        </div>
